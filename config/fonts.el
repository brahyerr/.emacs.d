...
(defun local/monospace-fonts ()
  ...
  (set-fontset-font t 'unicode "FiraMono Nerd Font" nil 'append)
...
(set-face-attribute 'variable-pitch nil :family "Klinic Slab Book" :height 1.25)
...
(add-hook 'org-mode-hook
	  (lambda ()
	    (variable-pitch-mode)
	    (set-face-attribute 'org-level-1 nil                   :family "Klinic Slab Book"                :height 1.75)
	    (set-face-attribute 'org-level-2 nil                   :family "Klinic Slab Book"                :height 1.6)
	    (set-face-attribute 'org-level-3 nil                   :family "Klinic Slab Book"                :height 1.5)
	    (set-face-attribute 'org-level-4 nil                   :family "Klinic Slab Book"                :height 1.3)
	    (set-face-attribute 'org-level-5 nil                   :family "Klinic Slab Book"                :height 1.25)
	    (set-face-attribute 'org-level-6 nil                   :family "Klinic Slab Book"                :height 1.25)
	    (set-face-attribute 'org-level-7 nil                   :family "Klinic Slab Book"                :height 1.25)
	    (set-face-attribute 'org-level-8 nil                   :family "Klinic Slab Book"                :height 1.25)
	    (set-face-attribute 'org-document-title nil            :family "Klinic Slab Book"                :height 1.25)
	    (set-face-attribute 'org-document-info nil             :family "Klinic Slab Book"                :height 1.25 :italic 1)
	    (set-face-attribute 'org-document-info-keyword nil     :family "Klinic Slab Book"                :height 1.25 :italic 1)
	    (set-face-attribute 'org-headline-done nil             :family "Klinic Slab Book"                :height 1.0 :italic 1)
	    (set-face-attribute 'org-done nil                      :family "Klinic Slab Book"                :height 1.0)
	    (set-face-attribute 'org-todo nil                      :family "Klinic Slab Book"                :height 1.0)))
